...
angular.module('testApp', ['ngSanitize']).controller('MainCtrl', MainCtrl);

},{"../styles/main.scss":3,"./controllers/main":2,"angular":7,"angular-sanitize":5,"console-polyfill":8,"es5-shim":11,"es5-shim/es5-sham":10}],2:[function(require,module,exports){
'use strict';
...
var MainCtrl = function MainCtrl($scope) {
  ...
  this.awesomeThings = ['HTML5 Boilerplate', 'AngularJS', 'Karma', 'tomi', 'tomi', 'tomi', 'not tomi'];
...
module.exports = require('sassify')('body {   background-color: #8a6343; } ');;
